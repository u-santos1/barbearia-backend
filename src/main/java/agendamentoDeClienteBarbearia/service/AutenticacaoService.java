...
public class AutenticacaoService implements UserDetailsService {
    ...
    // O @Lazy no manager é necessário para evitar Dependência Circular com o
    // SecurityConfig
    ...
    public TokenJWTData realizarLogin(LoginDTO dados) {
        ...
        try {
            ...
            // 2. Tenta autenticar (Vai chamar o loadUserByUsername e verificar hash da
            // senha)
            var authentication = manager.authenticate(authenticationToken);

            rateLimitService.limparTentativas(email);

            // 3. Se passou, pega o usuário logado (Cast seguro pois o manager retornou
            // sucesso)
            ...
            // Pega o nome da barbearia (se for dono, é a própria, se for funcionário, é a
            // do dono)
